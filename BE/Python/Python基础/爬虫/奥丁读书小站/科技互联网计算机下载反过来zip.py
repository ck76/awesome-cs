...
save_to_path = "/Users/chengkun/workspace/奥丁图书小站/科技互联网计算机/"
...
def get_num_and_name(bookname):
    ...
    result = str(pinyin.get_initial(bookname, delimiter="") + number)
...
with open(save_to_path + "科技互联网计算机失败的反过来zip.txt", 'w') as code:
