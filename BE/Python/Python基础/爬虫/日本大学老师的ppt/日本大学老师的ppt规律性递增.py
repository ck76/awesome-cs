...
# base_url="http://www.hino.meisei-u.ac.jp/is/iga/lecture/os/"
base_url = "https://ocw.kyoto-u.ac.jp/ja/09-faculty-of-engineering-jp/8a087b976a5f30bd30d530c830a630a730a2/pdf/cs0"
...
for item in range(1, 14):
    ...
    try:
        ...
        data = f.read()
        # 存储位置可自定义
        with open("/Users/chengkun/Downloads/" + str(item)+".pdf", 'wb') as code:
            code.write(data)
        ok_s.append(url)
